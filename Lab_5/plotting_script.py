...
filename     = "Instrumentation_tran_readings"              #filename : This is name of the file containing the x and y values
Plot_Title   =  "Instrumentation Amplifier"
x_axis_label = "Time"
y_axis_label = "Voltage"
number_of_curves_in_plot = 2
legend_list = ["Vin1-Vin2", "Vout"] 
